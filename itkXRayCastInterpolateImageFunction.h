...
/** \class XRayCastInterpolateImageFunction
 * \brief Projective interpolation of an image at specified positions.
 *
 * XRayCastInterpolateImageFunction casts rays through a 3-dimensional
 * image and uses bilinear interpolation to integrate each plane of
 * voxels traversed. Real attenuation of X-Rays is simulated. 
 * The input image is supposed to be in HU.
 * 
...
class ITK_EXPORT XRayCastInterpolateImageFunction : 
    public InterpolateImageFunction<TInputImage,TCoordRep> 
{
public:
  /** Standard class typedefs. */
  typedef XRayCastInterpolateImageFunction                 Self;
...
private:
  XRayCastInterpolateImageFunction( const Self& ); //purposely not implemented
...
#include "itkXRayCastInterpolateImageFunction.txx"
#endif
